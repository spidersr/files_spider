...
database:set(bot_id.."spider:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."spider:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."spider:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."spider:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."spider:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function keko_tsahke_new(tshake1,tshake2)
if tshake2 and tshake2.first_name_ then 
if tshake2.first_name_:match("(.*)"..database:get(bot_id.."spider:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."spider:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local tshake_nnn = database:get(bot_id.."spider:nump"..msg.chat_id_) or 5
local tshake_nnn2 = database:get(bot_id.."spider:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
